...
jest.mock("./DisplaySettings/DisplaySettings.tsx", () => ({
  DisplaySettings: () => (
    <div data-testid="display-settings">Display Settings Component</div>
  ),
}));

jest.mock("./EmailSettings/EmailSettings.tsx", () => ({
  EmailSettings: () => (
    <div data-testid="email-settings">Email Settings Component</div>
  ),
}));

jest.mock("./ProfileSettings/ProfileSettings.tsx", () => ({
  ProfileSettings: () => (
    <div data-testid="profile-settings">Profile Settings Component</div>
  ),
}));
